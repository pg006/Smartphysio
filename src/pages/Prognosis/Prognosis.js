...
const Prognosis = () => {
  ...
  return (
    <React.Fragment>
    <div className='prognosis-main-div'>
      <div className='first-div d-flex justify-content-between align-item-center pt-2'>
        <div className='title'><h3>Prognosis</h3></div>
        <div className='side-btn'>
          <button type="submit" className='entry-btn' onClick={() => { naviagte("/prognosis/prognosisentry") }} >
          Prognosis Entry
          </button>
        </div>
      </div>
      <div className='Table-container'>
        <TableData
          resTableDataItems={prognosisData}
          isPagination={true}
          isSelectable={false}
          columns={columns}
        />
